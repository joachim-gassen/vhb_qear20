...
## a. Subject -> Er̦ffnungen
#How many "Er̦ffnung" per day were recorded? ->
...
#Now we can count the amount of Er̦ffnungen per day:
library(plyr)
...
## 3. Identifying rows duplication
#no_duplicates_data <- unique(insolvency_filings_de_julaug2020_incomplete[, 1:6 ] )
#table(no_duplicates_data$court_file_number)
#new_file_number <- no_duplicates_data %>% group_by(court_file_number) %>% tally()
